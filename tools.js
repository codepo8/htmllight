...
function addbold(){
	...
	add="<b>"+content+"</b>";
	if (document.all){document.mainform.code.value=old+add;}
...
function addstring(string){
	domlay ('formin',1);
	clearall();
	if (document.all){old=document.mainform.code.value;}
...
function oops(){
	clearall();
		if (old!=""){
			if (document.all){document.mainform.code.value=old;}
...
function preview(){
	edit('test');
	if (document.all){cont=document.mainform.code.value;}
...
function save(){
	...
	if (document.all){document.mainform.elements["save"+slot].value=old;}
